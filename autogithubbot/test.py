...
#     def test_that_replies_correctly(self):
#         pass

#     def test_that_doesnot_get_caught_in_loop(self):
#         pass
...
#     def test_parse_with_invalid_message(self):
#         message = Message("Don't reply to me, please.")
#         res = self.parser.parse(message)
#         self.assertEqual(res, (False, ''))

#     def test_parse_with_valid_message(self):
#         message = Message("<a href='https://github.com/naiyt/reddit-replier'>Redditreplier</a>")
#         res = self.parser.parse(message)
#         self.assertEqual(res[0], True)
#         self.assertIn("A Python repository", res[1])

#     def test_parse_path_without_href(self):
#         link = '<a src=test>Test</a>'
#         res = self.parser._parse_path(link)
#         self.assertEqual(res, False)
